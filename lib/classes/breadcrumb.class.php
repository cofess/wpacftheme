<?php
/**
 * Breadcrumb of Yiwell WordPress Theme
 * Description:类 - 面包屑导航
 *
 * @package   Yiwell
 * @version   1.0.0
...
public function bread_crumb( $args = '' ) {
	...
	$default = array(
		'type'				=> 'list',
		'home_label'		=> __( 'Home', 'CS_TEXTDOMAIN' ),
		'search_label'		=> __( 'Search Result of "%s"', 'CS_TEXTDOMAIN' ),
		'404_label'			=> __( '404 Not Found', 'CS_TEXTDOMAIN' ),
		'category_label'	=> _x( '%s', 'category label', 'CS_TEXTDOMAIN' ),
		'tag_label'			=> _x( '%s', 'tag label', 'CS_TEXTDOMAIN' ),
		'taxonomy_label'	=> _x( '%s', 'taxonomy label', 'CS_TEXTDOMAIN' ),
		'author_label'		=> _x( '%s', 'author label', 'CS_TEXTDOMAIN' ),
		'attachment_label'	=> _x( '%s', 'attachment label', 'CS_TEXTDOMAIN' ),
		'year_label'		=> _x( '%s', 'year label', 'CS_TEXTDOMAIN' ),
		'month_label'		=> _x( '%s', 'month label', 'CS_TEXTDOMAIN' ),
		'day_label'			=> _x( '%s', 'day label', 'CS_TEXTDOMAIN' ),
		'post_type_label'	=> _x( '%s', 'post type label', 'CS_TEXTDOMAIN' ),
		'single_label'	    => _x( 'details', 'CS_TEXTDOMAIN' ),
		'joint_string'		=> __( ' &gt; ', 'CS_TEXTDOMAIN' ),
		'navi_element'		=> '',
		'elm_class'			=> 'breadcrumb',
		'elm_id'			=> '',
		'li_class'			=> '',
		'class_prefix'		=> '',
...
private function get_bread_crumb_array( $args ) {
	...
	if ( is_404() ) {
		...
		$bread_crumb_arr[] = array( 'title' => $args['single_label'], 'link' => get_permalink( $post->ID ) );
