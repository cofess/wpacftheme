...
class CSFramework_Option_backup extends CSFramework_Options {
  ...
  public function output() {
    ...
    echo '<a href="'. admin_url( 'admin-ajax.php?action=cs-export-options&option_array=' . $this->unique ) .'" class="button button-primary" target="_blank">'. __( 'Export and Download Backup', 'cs-framework' ) .'</a>';
