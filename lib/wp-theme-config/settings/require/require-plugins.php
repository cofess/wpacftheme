...
return function($value) 
{
	...
	$require_plugins = WpThemeConfig\Configurator::getInstance()->get('require.require-plugins');

	require_once( WP_THEME_CONFIG_DIR . '/class/class-tgm-plugin-activation.php' );
