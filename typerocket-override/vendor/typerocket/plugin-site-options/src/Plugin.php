<?php
namespace TypeRocketSiteOptions;
...
class Plugin
{
    ...
    public function __construct()
    {
        ...
        function link_fields(\TypeRocket\Elements\Form $form) {
            return [
                $form->text('Text'),
    ...
    public function setup()
    {
        $options = [
            ...
            'menu'=> 'Site Options',
            'view_file' => apply_filters('trp_site_options_page', __DIR__ . '/../page.php'),
            'position' => 60
        ];

        $menu = [
            'capability'=> $this->capability,
            'view_file' => apply_filters( 'trp_site_options_menu_page', __DIR__ . '/../menu.php'),
            'position' => 60
        ];
