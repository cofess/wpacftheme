	...
	private function link_html( $page, $total, $top, $bottom ) {
        ...
        <ul class="navigation">
			...
			if( $page != "1" ){
                ...
                <li>
                    <a href="<?php echo get_pagenum_link( 1 ); ?>">
						<?php echo apply_filters( 'lib/theme/paginate_double_back', '&laquo' ); ?>
                    </a>
                </li>
                <li>
                    <a href="<?php echo get_pagenum_link( $page - 1 ); ?>">
						<?php echo apply_filters( 'lib/theme/paginate_back', '&lt' ); ?>
                    </a>
                </li>
				<?php
			}
			...
			if( $page != $total ){
                ...
                <li>
                    <a href="<?php echo get_pagenum_link( $page + 1 ); ?>">
						<?php echo apply_filters( 'lib/theme/paginate_next', '&gt;' ); ?>
                    </a>
                </li>
                <li>
                    <a href="<?php echo get_pagenum_link( $total ); ?>">
						<?php echo apply_filters( 'lib/theme/paginate_double_next', '&raquo;' ); ?>
                    </a>
                </li>
				<?php
			}
