...
define( 'XMLSF_URI', get_template_directory_uri() . str_replace(wp_normalize_path(get_template_directory()),'',wp_normalize_path(dirname(__FILE__))) );

require XMLSF_DIR . '/models/global.php';

require XMLSF_DIR . '/controllers/global.php';

require XMLSF_DIR . '/views/admin/page-submit-sitemap.php';
