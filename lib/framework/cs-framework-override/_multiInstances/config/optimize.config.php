...
// ===============================================================================================
$settings = array(
	'menu_title'      => 'Optimize Options',
	'menu_type'       => 'menu',
	//'menu_slug'       => 'cs-framework', //todo this is where the framework breaks. An issue discovered is themes.php?page=cs-framework and admin.php?page=cs-framework is the same and creates conflict if same "menu_slug" is used for two instances of the framework even if "menu_type" is different (menu, theme).
	'menu_slug'       => 'optimize-options',
	'ajax_save'       => false,
	'show_reset_all'  => false,
	'framework_title' => 'Optimize Options',
	'option_array'    => '_optimize_options', //this most unique variable **required** from now on. Leave to use default CS_OPTION but not recommended. BETTER to use your plugin name or theme name. <<SHOULD BE UNIQUE>>. This is the variable that gets used as the option name. So get_option('<<option_array>>') | update_option('<<option_array>>')
);
