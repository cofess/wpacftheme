...
$settings = array(
	...
	'menu_slug'       => 'plugin-options',
	'ajax_save'       => false,
	'show_reset_all'  => false,
	'framework_title' => 'Plugin Options',
	'option_array'    => '_plugin_options', //this most unique variable **required** from now on. Leave to use default CS_OPTION but not recommended. BETTER to use your plugin name or theme name. <<SHOULD BE UNIQUE>>. This is the variable that gets used as the option name. So get_option('<<option_array>>') | update_option('<<option_array>>')
);
