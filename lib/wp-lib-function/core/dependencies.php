...
if ( ! function_exists( 'wp_is_plugin_active' ) ) {
	 ...
	 *
	 * @return bool
	 * @uses \Lib\Core\Dependencies::is_active()
	 *
	 */
	function wp_is_plugin_active( $plugin_file ) {
		return \Lib\Core\Dependencies::is_active( $plugin_file );
	}
}
...
if ( ! function_exists( 'wp_is_plugin_installed' ) ) {
	...
	function wp_is_plugin_installed( $plugin_file ) {
		return \Lib\Core\Dependencies::is_installed( $plugin_file );
	}
}
...
if ( ! function_exists( 'wp_is_plugin_network_active' ) ) {
	 ...
	 *
	 * @return bool
	 * @uses \Lib\Core\Dependencies::is_network_active()
	 *
	 */
	function wp_is_plugin_network_active( $plugin_file ) {
		return \Lib\Core\Dependencies::is_network_active( $plugin_file );
	}
}
...
if ( ! function_exists( 'wp_is_site_plugin_active' ) ) {
	 ...
	 *
	 * @return bool
	 * @uses \Lib\Core\Dependencies::is_site_active()
	 *
	 */
	function wp_is_site_plugin_active( $plugin_file ) {
		return \Lib\Core\Dependencies::is_site_active( $plugin_file );
	}
}
...
if ( ! function_exists( 'wp_is_plugin_inactive' ) ) {
	 ...
	 *
	 * @return bool
	 * @uses \Lib\Core\Dependencies::is_inactive()
	 *
	 */
	function wp_is_plugin_inactive( $plugin_file ) {
		return \Lib\Core\Dependencies::is_inactive( $plugin_file );
	}
}
...
if ( ! function_exists( 'plugin_version' ) ) {
	 ...
	 *
	 * @return string|bool
	 * @uses \Lib\Core\Dependencies::version()
	 *
	 */
	function plugin_version( $plugin ) {
		return \Lib\Core\Dependencies::version( $plugin );
	}
}
...
if ( ! function_exists( 'plugin_version_gt' ) ) {
	 ...
	 *
	 * @return bool
	 * @uses \Lib\Core\Dependencies::version_gt()
	 *
	 */
	function plugin_version_gt( $plugin, $compare_version ) {
		return \Lib\Core\Dependencies::version_gt( $plugin, $compare_version );
	}
}
...
if ( ! function_exists( 'plugin_version_gte' ) ) {
	 ...
	 *
	 * @return bool
	 * @uses \Lib\Core\Dependencies::version_gte()
	 *
	 */
	function plugin_version_gte( $plugin, $compare_version ) {
		return \Lib\Core\Dependencies::version_gte( $plugin, $compare_version );
	}
}
...
if ( ! function_exists( 'plugin_version_lte' ) ) {
	 ...
	 *
	 * @return bool
	 * @uses \Lib\Core\Dependencies::version_lte()
	 *
	 */
	function plugin_version_lte( $plugin, $compare_version ) {
		return \Lib\Core\Dependencies::version_lte( $plugin, $compare_version );
	}
}
...
if ( ! function_exists( 'plugin_version_lt' ) ) {
	 ...
	 *
	 * @return bool
	 * @uses \Lib\Core\Dependencies::version_lt()
	 *
	 */
	function plugin_version_lt( $plugin, $compare_version ) {
		return \Lib\Core\Dependencies::version_lt( $plugin, $compare_version );
	}
}
