...
<div class="wrap"> 
    ...
    <table class="wp-list-table widefat fixed striped" cellspacing="0" id="data-d">
        <thead>
            <tr>
                <th colspan="2" ><h3 style="margin: 5px 0"><?php _e('WordPress Information', 'bsi'); ?></h3></th>
            </tr>
        </thead>
        ...
        <thead>
            <tr>
                <th colspan="2" style="border-top: 1px solid #e1e1e1;"><h3 style="margin: 5px 0"><?php _e('Server Information', 'bsi'); ?></h3></th>
            </tr>
        </thead>
        ...
        <thead>
        <tr>
            <th colspan="2" style="border-top: 1px solid #e1e1e1;"><h3 style="margin: 5px 0"><?php _e('Current Theme', 'bsi'); ?></h3></th>
        </tr>
        </thead>
        ...
        <thead>
        <tr>
            <th colspan="2" style="border-top: 1px solid #e1e1e1;"><h3 style="margin: 5px 0"><?php _e('Active Plugins', 'bsi'); ?> (<?php echo count((array) get_option('active_plugins')); ?>)</h3></th>
        </tr>
        <thead>
