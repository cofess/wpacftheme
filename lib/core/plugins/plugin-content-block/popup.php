...
// Add button above editor if not editing block
function add_content_block_icon() {
	...
	echo '<a id="add-content-block" class="button thickbox cpw-button" title="' . __("Add Content Block", 'custom-post-widget' ) . '" href="#TB_inline?width=600&height=240&inlineId=content-block-form">
		<span class="dashicons dashicons-screenoptions"></span>' . __("Add Content Block", "custom-post-widget") . '
	</a>';
}
